          ...
          <div className="p-8 md:p-10 space-y-8">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                <label className="font-body text-[11px] font-bold text-[#3D3D3A] uppercase tracking-widest ml-1">Établissement / École</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="font-body text-[11px] font-bold text-[#3D3D3A] uppercase tracking-widest ml-1">Diplôme / Titre</label>
                  <input 
                    {...register("degree")} 
                ...
                <div className="space-y-2">
                  <label className="font-body text-[11px] font-bold text-[#3D3D3A] uppercase tracking-widest ml-1">Domaine d'études</label>
                  <input 
                    {...register("field")} 
                    className="w-full h-12 bg-[#F7F7F5] border border-[#E8E8E4] rounded-xl px-5 font-body text-[14px] focus:outline-none focus:border-[#0A0A0A] transition-colors"
            ...
            <div className="flex items-center gap-3">
              <label className="font-body text-[11px] font-bold text-[#888888] uppercase tracking-widest">Priorité d'affichage</label>
            ...
            <div className="space-y-2">
              <label className="font-body text-[11px] font-bold text-[#3D3D3A] uppercase tracking-widest ml-1">Description (Optionnel)</label>
              <textarea 
                {...register("description")} 
                className="w-full min-h-[120px] bg-[#F7F7F5] border border-[#E8E8E4] rounded-xl p-5 font-body text-[14px] focus:outline-none focus:border-[#0A0A0A] transition-colors resize-none leading-relaxed"
